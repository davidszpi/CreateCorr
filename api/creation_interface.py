...
def Creation_Interface(liste_widget, liste_options, padx=0):
    for i, ligne_widget in enumerate(liste_widget):
        for j, widg in enumerate(ligne_widget):
            widg.grid(row=i, column=j,
                      columnspan=liste_options[i][j][0],
                      pady=liste_options[i][j][1],
                      sticky=liste_options[i][j][2],
                      padx=padx)
